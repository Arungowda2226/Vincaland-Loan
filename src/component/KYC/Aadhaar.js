...
const Aadhaar = ({ showCheck, markComplete, formData, setFormData }) => {
    ...
    const handleUpload = () => {
        ...
        // Log selected files for confirmation
        files.forEach((file, index) => {
            console.log(`File ${index + 1}:`, file);
        });

        // Save selected files into formData
        setFormData(prev => ({
            ...prev,
            aadhaarFiles: files, // use a key that makes sense for your form
        }));
